# ファームの版（刻印に入る＝RADIOSIM_FIELD_CONFIG.firmware_version）を git から取り、
# ヘッダに書く。**ビルドのたびに**走らせる（main/CMakeLists.txt の radiosim_field_version）。
#
#   cmake -DSRC_DIR=<git の作業ツリーの中> -DOUT=<radiosim_field_version.h> -P version.cmake
#
...
execute_process(
    ...
    OUTPUT_VARIABLE RADIOSIM_FIELD_COMMIT
    OUTPUT_STRIP_TRAILING_WHITESPACE
    RESULT_VARIABLE RADIOSIM_FIELD_GIT_RESULT)
if(NOT RADIOSIM_FIELD_GIT_RESULT EQUAL 0 OR RADIOSIM_FIELD_COMMIT STREQUAL "")
...
execute_process(
    ...
    WORKING_DIRECTORY ${SRC_DIR}
    OUTPUT_VARIABLE RADIOSIM_FIELD_DIRTY
    OUTPUT_STRIP_TRAILING_WHITESPACE
    RESULT_VARIABLE RADIOSIM_FIELD_GIT_RESULT)
if(NOT RADIOSIM_FIELD_GIT_RESULT EQUAL 0)
    message(FATAL_ERROR "git status に失敗しました（汚れているかを判定できません）")
endif()
if(NOT RADIOSIM_FIELD_DIRTY STREQUAL "")
    set(RADIOSIM_FIELD_COMMIT "${RADIOSIM_FIELD_COMMIT}-dirty")
endif()

set(content "/* 生成物（version.cmake がビルドのたびに書く）。手で編集しない。 */\n#define RADIOSIM_FIELD_FIRMWARE_VERSION \"${RADIOSIM_FIELD_COMMIT}\"\n")
