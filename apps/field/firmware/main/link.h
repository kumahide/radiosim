...
void link_send_tx_packet(const radiosim_field_tx_packet_t *m);
void link_send_rx_sample(const radiosim_field_rx_sample_t *m);
void link_send_config(const radiosim_field_config_t *m);
