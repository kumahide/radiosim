...
└── tests/
    ...
    ├── test_tracer_bench.py
    ├── test_tracer_monitor.py
    ├── test_project.py
    ├── test_report_map.py
    ├── test_map_window.py
    ├── test_coords.py
