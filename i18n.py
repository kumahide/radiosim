...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "proj_loaded":          "Project loaded.\nBatch rows, scenario conditions and the relay route are applied when you open those windows.",
        "proj_close_title":     "Open Project",
        "proj_close_confirm":   "Loading a project closes the open windows (batch / scenario / relay route). Unsaved edits in them are lost.\n\nContinue?",
        "proj_warn_multihop":   "\n\n⚠️ The relay route was not saved because it has values that cannot be read: {reason}",
        "proj_warn_batch":      "\n\n⚠️ The batch rows were not saved because row \"{id}\" has values that cannot be read.",
        ...
        "hint_common_readonly": "🔒 read-only snapshot from Launcher",
        ...
        "scn_open_btn":         "Condition Explorer",
        ...
        "scn_fixed_group":      " Fixed Path ",
        "scn_fixed_path":       "Fixed path",
        "scn_path":             "Path",
        "scn_samples":          "Samples",
        ...
        "mh_role_rx":           "(RX)",
        "mh_role_relay":        "(relay)",
        "mh_open_btn":          "Relay Path",
        "mh_route_id":          "Route ID",
        "mh_waypoints":         " Waypoints ",
        "mh_hops_group":        " Hop Settings ",
        "mh_result":            " Result ",
        "mh_col_no":            "#",
        "mh_col_name":          "Name",
        ...
        "mh_running":           "Hop {i} / {n}…",
        "mh_summary":           "Overall: {status}   Worst margin: {margin} dB   ({worst})",
        "mh_err_coord":         "Point {no} ({name}): coordinates must be \"lat, lon\" and the height a number.",
        "mh_err_no_map":        "The map window is not available from here.",
    ...
    "ja": {
        ...
        "proj_loaded":          "プロジェクトを読み込みました。\nバッチ行・条件探索の条件・中継経路は、それぞれの窓を開いたときに反映されます。",
        "proj_close_title":     "プロジェクトを開く",
        "proj_close_confirm":   "プロジェクトを読み込むと、開いている窓（一括／条件探索／中継経路）を閉じます。保存していない編集は失われます。\n\n続けますか？",
        "proj_warn_multihop":   "\n\n⚠️ 中継経路は読めない値があるため保存していません: {reason}",
        "proj_warn_batch":      "\n\n⚠️ バッチの行は「{id}」に読めない値があるため保存していません。",
        ...
        "hint_common_readonly": "🔒 ランチャーのスナップショット（読み取り専用）",
        ...
        "scn_fixed_group":      " 固定した経路 ",
        "scn_fixed_path":       "固定した経路",
        "scn_path":             "経路",
        "scn_samples":          "サンプル数",
        ...
        "mh_running":           "ホップ {i} / {n} を計算中…",
        "mh_summary":           "全体判定: {status}   最小マージン: {margin} dB   （{worst}）",
        "mh_err_coord":         "地点 {no}（{name}）: 座標は「緯度, 経度」、地上高は数値で入力してください。",
