...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "tm_nw":                "NW",
        "tm_se":                "SE",
        "tm_btn_update_bbox":   "Update",
        "tm_tile_count":        "{n} areas",
        "tm_btn_check":         "Check Coverage",
        "tm_btn_download":      "Download ▶",
        "tm_btn_delete":        "Delete Range",
        "tm_btn_delete_all":    "Delete All Cache",
        "tm_force_download":    "Force refresh",
        "tm_hint":              "Left-click: 1st click = NW corner, 2nd click = SE corner",
        "tm_checking":          "Checking coverage…",
        "tm_check_result":      "5m Aerial: {area_5a} | 5m Photo: {area_5b} | 10m: {area_dem} | No data: {area_none}  /  Total: {area_total} areas",
        ...
        "tm_delete_confirm":    "Delete cached tiles in the selected range?",
        ...
        "tm_err_no_bbox":       "Please specify NW and SE coordinates first.",
    ...
    "ja": {
        ...
        "tm_nw":                "NW",
        "tm_se":                "SE",
        "tm_btn_update_bbox":   "更新",
        "tm_tile_count":        "{n} エリア",
        "tm_btn_check":         "カバレッジ確認",
        "tm_btn_download":      "ダウンロード ▶",
        "tm_btn_delete":        "範囲削除",
        "tm_btn_delete_all":    "全キャッシュ削除",
        "tm_force_download":    "強制再取得",
        "tm_hint":              "左クリック: 1回目 = NW角、2回目 = SE角",
        "tm_checking":          "カバレッジ確認中…",
        "tm_check_result":      "5m航空: {area_5a} | 5m写真: {area_5b} | 10m: {area_dem} | データなし: {area_none}  /  計{area_total}エリア",
        ...
        "tm_delete_confirm":    "選択範囲のキャッシュタイルを削除しますか？",
        ...
        "tm_err_no_bbox":       "先にNW・SE座標を指定してください。",
