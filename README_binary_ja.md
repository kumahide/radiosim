...
> **注意**: フォルダ内の構成は変更しないでください。`RadioSim.exe` 単体では動作しません。

### 起動

`RadioSim.exe` をダブルクリックします。
...
実際の電波伝搬では大気の屈折により電波は地球の曲率より大きく曲がります。これを等価地球半径係数 K でモデル化します。
